...
with app.app_context():
    ...
    query_1 = """INSERT INTO "Courses" ("CourseName", "Semester", "Year")
                 VALUES ('Calc II', 'Spring', 2025),
				 ('Software Dev II', 'Fall', 2028),
				 ('Intro to Time Traveling', 'Fall', 1954);
              """
